...
public class ReactionNetworkUtils {
	...
	public static int getSpeciesIndex(MassActionReactionNetwork network, String speciesName) {
	...
	public static int getReactionIndex(MassActionReactionNetwork network, String reactionName) {
	...
	public static DenseMatrix64F createStochiometryMatrix(MassActionReactionNetwork network) {
