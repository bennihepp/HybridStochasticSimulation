...
public class AdaptiveStepPDMPSimulatorOld extends StepPDMPSimulator {

	private AdaptiveStepSolver solver;

	public AdaptiveStepPDMPSimulatorOld() {
		this(null, null);
	}

	public AdaptiveStepPDMPSimulatorOld(RandomDataGenerator rdg) {
		this(null, rdg);
	}

	public AdaptiveStepPDMPSimulatorOld(AdaptiveStepSolver solver) {
		this(solver, null);
	}

	public AdaptiveStepPDMPSimulatorOld(AdaptiveStepSolver solver, RandomDataGenerator rdg) {
		super(rdg);
		if (solver == null)
