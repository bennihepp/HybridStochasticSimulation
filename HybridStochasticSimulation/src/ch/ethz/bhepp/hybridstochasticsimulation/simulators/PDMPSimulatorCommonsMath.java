...
import ch.ethz.bhepp.hybridstochasticsimulation.trajectories.ContinuousTrajectoryRecorder;
...
//		        	System.arraycopy(ode.getPrimaryState(), 0, x, 0, x.length);
	        ...
	        int reaction = DiscreteProbabilityDistribution.sample(rdg, propVec);
