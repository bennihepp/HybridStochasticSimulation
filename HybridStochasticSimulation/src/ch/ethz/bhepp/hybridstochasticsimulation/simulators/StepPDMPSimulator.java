...
abstract public class StepPDMPSimulator extends AbstractSimulator<PDMPModel> {
	...
	protected void beginRecording(PDMPModel model, PDMPSimulationInformation simInfo, double t0, double[] x0, double t1) {
	...
	protected void record(PDMPModel model, PDMPSimulationInformation simInfo, double t, double[] x) {
	...
	protected void endRecording(PDMPModel model, PDMPSimulationInformation simInfo, double t1, double[] x1) {
