...
public class Main {
	...
	public static List<FinitePlotData> trivialNetwork() {
		...
		List<VectorFinitePlotData> tdList = SimulationUtilities.simulateLsodarAdaptiveMSPDMP(nss, tSeries, printMessages);
...
//		plotDataList.add(td);
		...
		List<VectorFinitePlotData> tdList = SimulationUtilities.simulateLsodarAdaptiveMSPDMP(nss, tSeries, printMessages, true);
		VectorFinitePlotData tds;
		tds = tdList.get(0);
		tds.setDescription("AdaptiveMSPDMP");
		plotDataList.add(tds);
		if (tdList.size() > 0) {
			...
			plotDataList.add(tds);
			tds = tdList.get(5);
			tds.setDescription("AdaptiveMSPDMP z");
			plotDataList.add(tds);
		}
...
//		if (tdList.size() > 1) {
//			tds = tdList.get(1);
//			tds.setDescription("AdaptiveMSPDMP ks=10kd alphas");
//			plotDataList.add(tds);
//			tds = tdList.get(2);
//			tds.setDescription("AdaptiveMSPDMP ks=10kd rhos");
//			plotDataList.add(tds);
//			tds = tdList.get(3);
//			tds.setDescription("AdaptiveMSPDMP ks=10kd betas");
//			plotDataList.add(tds);
//			tds = tdList.get(4);
//			tds.setDescription("AdaptiveMSPDMP ks=10kd RTTs");
//			plotDataList.add(tds);
//			tds = tdList.get(5);
//			tds.setDescription("AdaptiveMSPDMP ks=10kd z");
//			plotDataList.add(tds);
//		}
...
//		if (tdList.size() > 1) {
//			tds = tdList.get(1);
//			tds.setDescription("AdaptiveMSPDMP ks=5kd alphas");
//			plotDataList.add(tds);
//			tds = tdList.get(2);
//			tds.setDescription("AdaptiveMSPDMP ks=5kd rhos");
//			plotDataList.add(tds);
//			tds = tdList.get(3);
//			tds.setDescription("AdaptiveMSPDMP ks=5kd betas");
//			plotDataList.add(tds);
//			tds = tdList.get(4);
//			tds.setDescription("AdaptiveMSPDMP ks=5kd RTTs");
//			plotDataList.add(tds);
//			tds = tdList.get(5);
//			tds.setDescription("AdaptiveMSPDMP ks=5kd z");
//			plotDataList.add(tds);
//		}
...
//		List<DefaultFinitePlotData> tdList = SimulationUtilities.simulateAdaptiveMSPDMP(nss, tSeries, printMessages);
//		DefaultFinitePlotData tds;
//		tds = tdList.get(0);
//		tds.setDescription("AdaptiveMSPDMP");
//		plotDataList.add(tds);
//		tds = tdList.get(1);
...
//		plotDataList.add(tdd);
		...
		plotDataList.add(tds);
		if (tdList.size() > 1) {
			tds = tdList.get(1).getSubsetData(states);
			tds.setDescription("AdaptiveMSPDMP alphas");
			plotDataList.add(tds);
			tds = tdList.get(2);
			tds.setDescription("AdaptiveMSPDMP rhos");
...
//		if (tdList.size() > 1) {
//			td = tdList.get(1);
//			td.setDescription("LsodarAdaptiveMSPDMP alphas");
//			plotDataList.add(td);
//			td = tdList.get(2);
//			td.setDescription("LsodarAdaptiveMSPDMP rhos");
//			plotDataList.add(td);
//			td = tdList.get(3);
//			td.setDescription("LsodarAdaptiveMSPDMP betas");
//			plotDataList.add(td);
//			td = tdList.get(4);
//			td.setDescription("LsodarAdaptiveMSPDMP RTTs");
//			plotDataList.add(td);
//		}
...
//		plotDataList.add(tdd.getSubsetData(7));
		...
		tdd = SimulationUtilities.simulateLsodarAdaptiveMSPDMPDistribution(PDMPRuns, nss, tSeries, printMessages);
		tdd.setDescription("AdaptiveMSPDMP distribution");
		for (int s=0; s < tdd.getNumberOfStates(); s++)
			plotDataList.add(tdd.getSubsetData(s));
////		plotDataList.add(tdd);
...
//		int[] dR = { 0, 1, 4, 5, 6, 11, 12, 13, 15 };
		...
		td = SimulationUtilities.simulateLsodarPDMP(nss, tSeries, printMessages);
		td.setDescription("PDMP");
		for (int s=0; s < td.getNumberOfStates(); s++)
			plotDataList.add(td.getSubsetData(s));
//		plotDataList.add(td);
