...
public class DeterministicSimulatorController {
	...
	private class SimulationWorker implements Callable<Trajectory> {

		private FiniteDeterministicTrajectory mt;
		private UnaryBinaryDeterministicModel model;
		private double t0;
		private double[] x0;
		private double t1;
		private DeterministicSimulator simulator;

		public SimulationWorker(FiniteDeterministicTrajectory mt,
				FirstOrderIntegrator integrator, UnaryBinaryDeterministicModel model,
			...
			this.x0 = x0;
			this.t1 = t1;
			simulator = new DeterministicSimulator(integrator);
		}

		public FiniteDeterministicTrajectory simulate() {
		...
		@Override
		public FiniteDeterministicTrajectory call() {
			return simulate();
		}
	}
	...
	public DeterministicSimulatorController() {
