...
public class DormandPrince853IntegratorFactory implements IntegratorFactory {
	...
	public DormandPrince853IntegratorFactory() {
		this(1.0e-10, 100.0, 1.0e-10, 1.0e-10, Integer.MAX_VALUE);
	}

	public DormandPrince853IntegratorFactory(double minStep, double maxStep,
