...
public class SubReactionNetworkGraph extends DirectedSubgraph<SpeciesVertex, ReactionEdge> implements ReactionNetworkGraph {
	...
	public static SubReactionNetworkGraph createSubReactionNetworkGraph(UnaryBinaryReactionNetwork network, Map<Integer,SpeciesVertex> verticesMap, Map<Integer,List<ReactionEdge>> edgesMap) {
	...
	private SubReactionNetworkGraph(UnaryBinaryReactionNetwork network, Set<SpeciesVertex> speciesSet, Set<ReactionEdge> reactionSet) {
