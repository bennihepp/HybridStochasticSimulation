...
public class FiniteStochasticModelTrajectory extends FiniteModelTrajectory implements ReactionEventHandler {

	public FiniteStochasticModelTrajectory(double[] tSeries) {
		super(tSeries);
	}
