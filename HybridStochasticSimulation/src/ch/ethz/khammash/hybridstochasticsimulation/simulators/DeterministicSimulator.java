...
import ch.ethz.khammash.hybridstochasticsimulation.models.DeterministicReactionNetworkModel;
...
public class DeterministicSimulator {
	...
	public DeterministicSimulator(FirstOrderIntegrator integrator) {
		if (integrator == null)
	...
	public double simulate(DeterministicReactionNetworkModel model, final double t0, final double[] x0, double t1, double[] x1) {
